...
// @updateURL      https://github.com/clavelm/iitc-plugins/raw/dist/keysByCobra.meta.js
// @downloadURL    https://github.com/clavelm/iitc-plugins/raw/dist/keysByCobra.user.js
...
plugin_info.dateTimeVersion = '2021-12-13-223100';
...
window.plugin.keys.setupContent = function() {
  plugin.keys.contentHTML = '<div id="keys-content-outer">'
							  ...
							  + '<div id="keys-clear-all" class="keys-button" onclick="window.plugin.keys.clearAllKeys();" ><a>delete all registered keys on keys plugin</a></div>'
                          + '</div>';
...
var setup =  function() {
  ...
  //ajout du bouton permettant d'effectuer l'action keys.clearAllKeys()
